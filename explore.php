...
<body>
    ...
    <div class="container" id="button" align="right">
        <div class="container">
            <a class="btn btn-outline-info" href="logout.php">Log out</a>
        </div>
        <br><br> 
    </div>

      <!-- <form class="form-inline my-2 my-lg-0">
        <button href class="btn btn-outline-success my-2 my-sm-0" type="submit">Log out</button>
      </form> -->
